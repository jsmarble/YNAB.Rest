...
namespace YNAB.Rest
{
    ...
    public interface IApiClient
    {
        ...
        Task<ApiResponse<AccountsData>> GetAccounts(string budgetId, [Header("Authorization")] string accessToken);
        ...
        Task<ApiResponse<AccountData>> GetAccount(string budgetId, string accountId, [Header("Authorization")] string accessToken);
        ...
        [Get("/budgets")]
        Task<ApiResponse<BudgetsData>> GetBudgets([Header("Authorization")] string accessToken);
        ...
        Task<ApiResponse<BudgetData>> GetBudget(string budgetId, [Header("Authorization")] string accessToken);
        ...
        Task<ApiResponse<CategoriesData>> GetCategories(string budgetId, [Header("Authorization")] string accessToken);
        ...
        Task<ApiResponse<CategoryData>> GetCategory(string budgetId, string categoryId, [Header("Authorization")] string accessToken);
        ...
        Task<ApiResponse<TransactionsData>> GetTransactions(string budgetId, [Header("Authorization")] string accessToken);
        ...
        Task<ApiResponse<TransactionsData>> GetTransactionsByAccount(string budgetId, string accountId, [Header("Authorization")] string accessToken);
        ...
        Task<ApiResponse<TransactionsData>> GetTransactionsByCategory(string budgetId, string categoryId, [Header("Authorization")] string accessToken);
        ...
        Task<ApiResponse<TransactionData>> GetTransaction(string budgetId, string transactionId, [Header("Authorization")] string accessToken);
    }
}
